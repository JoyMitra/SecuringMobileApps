...
import android.widget.Scroller;
	...
	public final class HorizontalPagerUtilityClass extends ViewGroup{
	    /*
	     ...
	     */
	    public HorizontalPagerUtilityClass(final Context context) {
	        super(context);
	        init();
	    }
	     ...
	     */
	    public HorizontalPagerUtilityClass(final Context context, final AttributeSet attrs) {
	        super(context, attrs);
	        init();
	    }
